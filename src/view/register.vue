  ...
  <div class="register page">
    ...
    <div class="contents">
      ...
      <span class="xqd-input-button">
         <input type="text" placeholder="验证码" v-model="registerFrom.verifycode">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      register() {
        let $self = this
        if ($self.registerFrom.phone.length === 0 || $self.registerFrom.verifycode.length === 0 || $self.registerFrom.username.length === 0) {
          Toast("长度不能为空")
        }
        else {
